...
const BASE_URL = loadEnv('', process.cwd()).VITE_BASE_URL;  //process.env.VITE_BASE_URL
const VITE_GLOBAL_TITLE = loadEnv('', process.cwd()).VITE_GLOBAL_TITLE;
...
const config = {
  ...
  plugins: [
    ...
    configHtmlPlugin(VITE_GLOBAL_TITLE,BASE_URL),
  ],
  build: {
