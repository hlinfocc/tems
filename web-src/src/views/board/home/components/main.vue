        ...
        <tiny-col :span="4">
          <div class="col">
            ...
            <div class="num">
              ...
              <div class="down">
                <span class="left">{{ hcdata.classesTotal }}</span>
        ...
        <tiny-col :span="4">
          <div class="col">
            ...
            <div class="num">
              ...
              <div class="down">
                <span class="left">{{ hcdata.coursesTotal }}</span>
                <span class="right">&nbsp;/ 门</span>
              </div>
            </div>
          </div>
        </tiny-col>
        <tiny-col :span="4">
          <div class="col">
            ...
            <div class="num">
              ...
              <div class="down">
                <span class="left">{{ hcdata.studentsTotal }}</span>
        ...
        <tiny-col :span="4">
          <div class="col">
            ...
            <div class="num">
              ...
              <div class="down">
                <span class="left">{{ hcdata.tasksTotal }}</span>
                <span class="right">&nbsp;/ 个</span>
              </div>
            </div>
          </div>
...
<script lang="ts" setup>
  ...
  import { homeCount } from '@/api/statistics';
