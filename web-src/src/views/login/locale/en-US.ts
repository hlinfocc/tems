export default {
  ...
  'login.form.mailName.placeholder': "EmailName",
  'login.form.mailpassword.placeholder': 'Password',
  ...
  'login.form.verifycode.placeholder': 'Captcha',
  'login.form.verifycode.errMsg': 'Captcha cannot be empty',
  ...
  'login.tip.info': 'User name; password',
  'login.tip.mail': "User name; password",
