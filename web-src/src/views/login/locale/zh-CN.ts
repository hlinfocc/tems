export default {
  ...
  'login.form.mailName.placeholder': "邮箱名",
  'login.form.mailpassword.placeholder': '密码',
  ...
  'login.form.verifycode.placeholder': '验证码',
  ...
  'login.tip.info': '用户名，密码',
  'login.tip.mail': "用户名，密码",
  'login.tip.right': '请输入正确的用户名密码',
  'login.main.text': '中后台前端解决方案',
};
